...
export default function CustomerSlide({ customer }: Props) {
  return (
    <div className="flex flex-col items-center px-[20px] py-[20px] min-[375px]:px-[48px] min-[375px]:py-[32px] sm:px-[90px] sm:py-[55px] xl:px-[125px] xl:py-[75px] bg-[linear-gradient(183.41deg,_#6888C8_-8.57%,_#5A98F2_82.96%)] relative overflow-hidden h-full">
      <h3 className="text-white text-center font-bold text-[20px] leading-[26px] min-[375px]:text-[24px] min-[375px]:leading-[28px] md:text-[28px] md:leading-[34px] lg:text-[36px] lg:leading-[48px] pb-[18px] md:pb-[24px] lg:pb-[30px] relative before:absolute before:w-[59px] before:h-[2px] before:rounded-[100%] before:bg-white before:bottom-0 before:left-[50%] before:translate-x-[-50%]">
